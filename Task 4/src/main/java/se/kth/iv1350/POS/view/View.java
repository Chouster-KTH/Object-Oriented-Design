...
import se.kth.iv1350.POS.integration.TotalRevenueDisplay;
...
public class View
{
    ...
    public View(Controller contr)
    {
        ...
        contr.addRevenueObserver(new TotalRevenueDisplay());
    ...
    public void sampleExecution(StoreInformation storeInformation)
    {
        ...
        contr.scan("001023", new Amount(1));
        contr.scan("03", new Amount(1));
        contr.scan("000000", new Amount(10));
        contr.endSale();
